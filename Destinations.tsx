        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <div className="relative">
             ...
             >
                ...
                <div className="relative">
                    <img 
                        src="https://images.unsplash.com/photo-1543269664-7eef42226a21?q=80&w=600&auto=format&fit=crop" 
                        className="rounded-2xl shadow-xl w-full h-64 object-cover" 
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
                        ...
                        <div className="group cursor-pointer">
                            <div className="text-4xl md:text-5xl font-black text-white tracking-tighter group-hover:scale-110 transition-transform duration-300">
                                Arizona State <span className="text-accent-500">University</span>
                            </div>
                            <div className="h-1 w-0 bg-accent-500 group-hover:w-full transition-all duration-500 mx-auto mt-2"></div>
                        </div>

                        {/* Generic "Top University" badges for visual density */}
                        <div className="text-2xl font-bold text-white/50 hover:text-white transition-colors">University of Canada West</div>
                        <div className="text-2xl font-bold text-white/50 hover:text-white transition-colors">EU Business School</div>
                    </div>
                </div>
